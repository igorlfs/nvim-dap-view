import"./Bzak7iHL.js";import"./BnYp5M1u.js";import{f as t,s as c,b as r,a as D}from"./BCdYson3.js";import{h as y}from"./BngIArCa.js";import{l as i,s as F}from"./DrqgEYiV.js";import{M as C}from"./DxNFfEMZ.js";const a={title:"Configuration"},{title:_}=a;var A=t('<h2 id="defaults"><a href="#defaults">Defaults</a></h2> <p>These are the default options from <code>nvim-dap-view</code>. You can use them as reference. You don’t have to copy-paste them.</p> <!>',1);function m(n,l){const p=i(l,["children","$$slots","$$events","$$legacy"]);C(n,F(()=>p,()=>a,{children:(o,E)=>{var s=A(),e=c(r(s),4);y(e,()=>`<pre class="shiki catppuccin-mocha" style="background-color:#1e1e2e;color:#cdd6f4" tabindex="0"><code><span class="line"><span style="color:#CBA6F7">return</span><span style="color:#CDD6F4"> &#123;</span></span>
