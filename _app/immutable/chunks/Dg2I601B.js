import{t,a as c}from"./Dfv75pGZ.js";import"./CTtJk3h0.js";import{s as r,f as D}from"./BvwYxhiU.js";import{h as y}from"./HHy36LI4.js";import{l as i,s as C}from"./DpwxDG4K.js";import{M as F}from"./D5kwoFFg.js";const a={title:"Configuration"},{title:_}=a;var A=t('<h2 id="defaults"><a href="#defaults">Defaults</a></h2> <p>These are the default options from <code>nvim-dap-view</code>. You can use them as reference. You don’t have to copy-paste them!</p> <!>',1);function w(n,l){const p=i(l,["children","$$slots","$$events","$$legacy"]);F(n,C(()=>p,a,{children:(o,E)=>{var s=A(),e=r(D(s),4);y(e,()=>`<pre class="shiki catppuccin-mocha" style="background-color:#1e1e2e;color:#cdd6f4" tabindex="0"><code><span class="line"><span style="color:#CBA6F7">return</span><span style="color:#CDD6F4"> &#123;</span></span>
