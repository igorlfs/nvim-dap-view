import"./Bzak7iHL.js";import"./BnYp5M1u.js";import{f as t,s as c,b as r,a as y}from"./BCdYson3.js";import{h as D}from"./BngIArCa.js";import{l as i,s as F}from"./DrqgEYiV.js";import{M as C}from"./Chxnmtql.js";const n={title:"Configuration"},{title:w}=n;var A=t('<h2 id="defaults"><a href="#defaults">Defaults</a></h2> <p>These are the default options from <code>nvim-dap-view</code>. You can use them as reference. You don’t have to copy-paste them.</p> <!>',1);function b(a,l){const p=i(l,["children","$$slots","$$events","$$legacy"]);C(a,F(()=>p,()=>n,{children:(o,E)=>{var s=A(),e=c(r(s),4);D(e,()=>`<pre class="shiki catppuccin-mocha" style="background-color:#1e1e2e;color:#cdd6f4" tabindex="0"><code><span class="line"><span style="color:#CBA6F7">return</span><span style="color:#CDD6F4"> &#123;</span></span>
...
<span class="line"><span style="color:#CDD6F4">            &#125;,</span></span>
<span class="line"><span style="color:#CDD6F4">            base_buttons </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> &#123;</span></span>
<span class="line"><span style="color:#CDD6F4">                play </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> &#123;</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    render</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">(</span><span style="color:#EBA0AC;font-style:italic">session</span><span style="color:#9399B2">)</span></span>
<span class="line"><span style="color:#CBA6F7">                        local</span><span style="color:#CDD6F4"> pausable </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> session </span><span style="color:#94E2D5">and</span><span style="color:#94E2D5"> not</span><span style="color:#CDD6F4"> session.stopped_thread_id</span></span>
<span class="line"><span style="color:#CBA6F7">                        return</span><span style="color:#CDD6F4"> statusline.</span><span style="color:#89B4FA;font-style:italic">hl</span><span style="color:#CDD6F4">(pausable </span><span style="color:#94E2D5">and</span><span style="color:#A6E3A1"> "" </span><span style="color:#94E2D5">or</span><span style="color:#A6E3A1"> ""</span><span style="color:#CDD6F4">, pausable </span><span style="color:#94E2D5">and</span><span style="color:#A6E3A1"> "ControlPause" </span><span style="color:#94E2D5">or</span><span style="color:#A6E3A1"> "ControlPlay"</span><span style="color:#CDD6F4">)</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    action</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">()</span></span>
<span class="line"><span style="color:#CBA6F7">                        local</span><span style="color:#CDD6F4"> session </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> dap.</span><span style="color:#89B4FA;font-style:italic">session</span><span style="color:#CDD6F4">()</span></span>
<span class="line"><span style="color:#CBA6F7">                        local</span><span style="color:#CDD6F4"> action </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> session </span><span style="color:#94E2D5">and</span><span style="color:#94E2D5"> not</span><span style="color:#CDD6F4"> session.stopped_thread_id </span><span style="color:#94E2D5">and</span><span style="color:#CDD6F4"> dap.pause </span><span style="color:#94E2D5">or</span><span style="color:#CDD6F4"> dap.continue</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                        action</span><span style="color:#CDD6F4">()</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                &#125;,</span></span>
<span class="line"><span style="color:#CDD6F4">                step_into </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> &#123;</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    render</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">(</span><span style="color:#EBA0AC;font-style:italic">session</span><span style="color:#9399B2">)</span></span>
<span class="line"><span style="color:#CBA6F7">                        local</span><span style="color:#CDD6F4"> stopped </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> session </span><span style="color:#94E2D5">and</span><span style="color:#CDD6F4"> session.stopped_thread_id</span></span>
<span class="line"><span style="color:#CBA6F7">                        return</span><span style="color:#89B4FA;font-style:italic"> require</span><span style="color:#CDD6F4">(</span><span style="color:#A6E3A1">"dap-view.util.statusline"</span><span style="color:#CDD6F4">).</span><span style="color:#89B4FA;font-style:italic">hl</span><span style="color:#CDD6F4">(</span></span>
<span class="line"><span style="color:#A6E3A1">                            ""</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                            stopped </span><span style="color:#94E2D5">and</span><span style="color:#A6E3A1"> "ControlStepInto" </span><span style="color:#94E2D5">or</span><span style="color:#A6E3A1"> "ControlNC"</span></span>
<span class="line"><span style="color:#CDD6F4">                        )</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    action</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">()</span></span>
<span class="line"><span style="color:#CDD6F4">                        dap.</span><span style="color:#89B4FA;font-style:italic">step_into</span><span style="color:#CDD6F4">()</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                &#125;,</span></span>
<span class="line"><span style="color:#CDD6F4">                step_over </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> &#123;</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    render</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">(</span><span style="color:#EBA0AC;font-style:italic">session</span><span style="color:#9399B2">)</span></span>
<span class="line"><span style="color:#CBA6F7">                        local</span><span style="color:#CDD6F4"> stopped </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> session </span><span style="color:#94E2D5">and</span><span style="color:#CDD6F4"> session.stopped_thread_id</span></span>
<span class="line"><span style="color:#CBA6F7">                        return</span><span style="color:#89B4FA;font-style:italic"> require</span><span style="color:#CDD6F4">(</span><span style="color:#A6E3A1">"dap-view.util.statusline"</span><span style="color:#CDD6F4">).</span><span style="color:#89B4FA;font-style:italic">hl</span><span style="color:#CDD6F4">(</span></span>
<span class="line"><span style="color:#A6E3A1">                            ""</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                            stopped </span><span style="color:#94E2D5">and</span><span style="color:#A6E3A1"> "ControlStepOver" </span><span style="color:#94E2D5">or</span><span style="color:#A6E3A1"> "ControlNC"</span></span>
<span class="line"><span style="color:#CDD6F4">                        )</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    action</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">()</span></span>
<span class="line"><span style="color:#CDD6F4">                        dap.</span><span style="color:#89B4FA;font-style:italic">step_over</span><span style="color:#CDD6F4">()</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                &#125;,</span></span>
<span class="line"><span style="color:#CDD6F4">                step_out </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> &#123;</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    render</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">(</span><span style="color:#EBA0AC;font-style:italic">session</span><span style="color:#9399B2">)</span></span>
<span class="line"><span style="color:#CBA6F7">                        local</span><span style="color:#CDD6F4"> stopped </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> session </span><span style="color:#94E2D5">and</span><span style="color:#CDD6F4"> session.stopped_thread_id</span></span>
<span class="line"><span style="color:#CBA6F7">                        return</span><span style="color:#89B4FA;font-style:italic"> require</span><span style="color:#CDD6F4">(</span><span style="color:#A6E3A1">"dap-view.util.statusline"</span><span style="color:#CDD6F4">).</span><span style="color:#89B4FA;font-style:italic">hl</span><span style="color:#CDD6F4">(</span></span>
<span class="line"><span style="color:#A6E3A1">                            ""</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                            stopped </span><span style="color:#94E2D5">and</span><span style="color:#A6E3A1"> "ControlStepOut" </span><span style="color:#94E2D5">or</span><span style="color:#A6E3A1"> "ControlNC"</span></span>
<span class="line"><span style="color:#CDD6F4">                        )</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    action</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">()</span></span>
<span class="line"><span style="color:#CDD6F4">                        dap.</span><span style="color:#89B4FA;font-style:italic">step_out</span><span style="color:#CDD6F4">()</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                &#125;,</span></span>
<span class="line"><span style="color:#CDD6F4">                step_back </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> &#123;</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    render</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">(</span><span style="color:#EBA0AC;font-style:italic">session</span><span style="color:#9399B2">)</span></span>
<span class="line"><span style="color:#CBA6F7">                        local</span><span style="color:#CDD6F4"> stopped </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> session </span><span style="color:#94E2D5">and</span><span style="color:#CDD6F4"> session.stopped_thread_id</span></span>
<span class="line"><span style="color:#CBA6F7">                        return</span><span style="color:#89B4FA;font-style:italic"> require</span><span style="color:#CDD6F4">(</span><span style="color:#A6E3A1">"dap-view.util.statusline"</span><span style="color:#CDD6F4">).</span><span style="color:#89B4FA;font-style:italic">hl</span><span style="color:#CDD6F4">(</span></span>
<span class="line"><span style="color:#A6E3A1">                            ""</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                            stopped </span><span style="color:#94E2D5">and</span><span style="color:#A6E3A1"> "ControlStepBack" </span><span style="color:#94E2D5">or</span><span style="color:#A6E3A1"> "ControlNC"</span></span>
<span class="line"><span style="color:#CDD6F4">                        )</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    action</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">()</span></span>
<span class="line"><span style="color:#CDD6F4">                        dap.</span><span style="color:#89B4FA;font-style:italic">step_back</span><span style="color:#CDD6F4">()</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                &#125;,</span></span>
<span class="line"><span style="color:#CDD6F4">                run_last </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> &#123;</span></span>
...
<span class="line"><span style="color:#CBA6F7">                        return</span><span style="color:#89B4FA;font-style:italic"> require</span><span style="color:#CDD6F4">(</span><span style="color:#A6E3A1">"dap-view.util.statusline"</span><span style="color:#CDD6F4">).</span><span style="color:#89B4FA;font-style:italic">hl</span><span style="color:#CDD6F4">(</span><span style="color:#A6E3A1">""</span><span style="color:#CDD6F4">, </span><span style="color:#A6E3A1">"ControlRunLast"</span><span style="color:#CDD6F4">)</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    action</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">()</span></span>
...
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                &#125;,</span></span>
<span class="line"><span style="color:#CDD6F4">                terminate </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> &#123;</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    render</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">(</span><span style="color:#EBA0AC;font-style:italic">session</span><span style="color:#9399B2">)</span></span>
<span class="line"><span style="color:#CBA6F7">                        return</span><span style="color:#89B4FA;font-style:italic"> require</span><span style="color:#CDD6F4">(</span><span style="color:#A6E3A1">"dap-view.util.statusline"</span><span style="color:#CDD6F4">).</span><span style="color:#89B4FA;font-style:italic">hl</span><span style="color:#CDD6F4">(</span></span>
<span class="line"><span style="color:#A6E3A1">                            ""</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                            session </span><span style="color:#94E2D5">and</span><span style="color:#A6E3A1"> "ControlTerminate" </span><span style="color:#94E2D5">or</span><span style="color:#A6E3A1"> "ControlNC"</span></span>
<span class="line"><span style="color:#CDD6F4">                        )</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    action</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">()</span></span>
...
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                &#125;,</span></span>
<span class="line"><span style="color:#CDD6F4">                disconnect </span><span style="color:#94E2D5">=</span><span style="color:#CDD6F4"> &#123;</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    render</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">(</span><span style="color:#EBA0AC;font-style:italic">session</span><span style="color:#9399B2">)</span></span>
<span class="line"><span style="color:#CBA6F7">                        return</span><span style="color:#89B4FA;font-style:italic"> require</span><span style="color:#CDD6F4">(</span><span style="color:#A6E3A1">"dap-view.util.statusline"</span><span style="color:#CDD6F4">).</span><span style="color:#89B4FA;font-style:italic">hl</span><span style="color:#CDD6F4">(</span></span>
<span class="line"><span style="color:#A6E3A1">                            ""</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#CDD6F4">                            session </span><span style="color:#94E2D5">and</span><span style="color:#A6E3A1"> "ControlDisconnect" </span><span style="color:#94E2D5">or</span><span style="color:#A6E3A1"> "ControlNC"</span></span>
<span class="line"><span style="color:#CDD6F4">                        )</span></span>
<span class="line"><span style="color:#CBA6F7">                    end</span><span style="color:#CDD6F4">,</span></span>
<span class="line"><span style="color:#89B4FA;font-style:italic">                    action</span><span style="color:#94E2D5"> =</span><span style="color:#CBA6F7"> function</span><span style="color:#9399B2">()</span></span>
