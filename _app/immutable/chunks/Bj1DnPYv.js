import{t,a as c}from"./BLxlZUrJ.js";import"./CFq3jESr.js";import{s as r,f as D}from"./eUeLa1OZ.js";import{h as y}from"./CT0RkVi8.js";import{l as i,s as C}from"./BNd-5Pst.js";import{M as F}from"./oFaaERDc.js";const a={title:"Configuration"},{title:_}=a;var A=t('<h2 id="defaults"><a href="#defaults">Defaults</a></h2> <p>These are the default options from <code>nvim-dap-view</code>. You can use them as reference. You don’t have to copy-paste them!</p> <!>',1);function w(n,l){const p=i(l,["children","$$slots","$$events","$$legacy"]);F(n,C(()=>p,a,{children:(o,E)=>{var s=A(),e=r(D(s),4);y(e,()=>`<pre class="shiki catppuccin-mocha" style="background-color:#1e1e2e;color:#cdd6f4" tabindex="0"><code><span class="line"><span style="color:#CBA6F7">return</span><span style="color:#CDD6F4"> &#123;</span></span>
